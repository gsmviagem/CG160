  ...
  return (
    <div className="bg-gray-900 border border-gray-800 rounded-lg p-4 hover:border-gray-700 transition-colors">
      <div className="flex items-start justify-between gap-3 mb-2">
        <div>
          <span className="text-xs text-gray-500 uppercase tracking-wider">Ideia</span>
      ...
      <div className="flex items-center gap-2 flex-wrap mb-3">
        ...
        {idea.created_at && (
          <span className="text-xs text-gray-600 ml-auto">{relativeTime(idea.created_at)}</span>
        )}
      </div>
      ...
      <div className="flex items-start gap-3 mb-3">
        {video.thumbnail_url ? (
          ...
          <div className="w-16 h-28 rounded bg-gray-800 flex items-center justify-center flex-shrink-0">
            <span className="text-gray-600 text-xs">Sem thumb</span>
          </div>
        )}
        <div className="flex-1 min-w-0">
          <span className="text-xs text-gray-500 uppercase tracking-wider">Vídeo</span>
